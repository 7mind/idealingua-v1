...
export class TestInterface1Struct implements TestInterface1 {
    ...
    public static readonly PackageName = 'izumi.test.domain02.TestInterface1';
    public static readonly ClassName = 'Struct';
    public static readonly FullClassName = 'izumi.test.domain02.TestInterface1.Struct';
...
Introspector.register('izumi.test.domain02.TestInterface1', {
        full: 'izumi.test.domain02.TestInterface1',
