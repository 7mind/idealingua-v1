  ...
  implicit val decodeWithCovariance: Decoder[WithCovariance] = Decoder.instance(c => {
    ...
    for (fname <- maybeContent; value = c.downField(fname); result <- fname match {
      ...
      case _ =>
        ...
        val alts = List("idltest.inheritance.CovariantDTO1", "idltest.inheritance.CovariantDTO2", "idltest.inheritance.InheritedCovariant.Struct", "idltest.inheritance.WithCovariance.Struct").mkString(",")
