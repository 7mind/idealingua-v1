...
trait PointLikeCirce {
  ...
  implicit val decodePointLike: Decoder[PointLike] = Decoder.instance(c => {
    ...
    for (fname <- maybeContent; value = c.downField(fname); result <- fname match {
      ...
      case _ =>
        val cname = "idltest.inheritance.PointLike"
        val alts = List("idltest.inheritance.PointLike.Struct").mkString(",")
...
object PointLike extends PointLikeCirce {
  ...
  object Struct extends PointLike.StructCirce {
    ...
    implicit object Struct_cast_into_Point extends izumi.idealingua.runtime.IRTCast[PointLike.Struct, Point] {
      override def convert(_value: PointLike.Struct): Point = {
  ...
  implicit object PointLike_cast_into_Point extends izumi.idealingua.runtime.IRTCast[PointLike, Point] {
    override def convert(_value: PointLike): Point = {
      assert(_value.asInstanceOf[_root_.scala.AnyRef] ne null)
      Point(id = _value.id, name = _value.name, x = _value.x, y = _value.y)
    }
  }
