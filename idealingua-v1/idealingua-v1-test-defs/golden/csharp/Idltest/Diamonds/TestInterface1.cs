...
namespace Idltest.Diamonds {
    ...
    public class TestInterface1Struct : TestInterface1 {
        public static readonly string RTTI_PACKAGE = "idltest.diamonds.TestInterface1";
        public static readonly string RTTI_CLASSNAME = "Struct";
        public static readonly string RTTI_FULLCLASSNAME = "idltest.diamonds.TestInterface1.Struct";
        ...
        public TestInterface1Struct(int if1Field_overriden, int if1Field_inherited, long sameField, long sameEverywhereField) {
