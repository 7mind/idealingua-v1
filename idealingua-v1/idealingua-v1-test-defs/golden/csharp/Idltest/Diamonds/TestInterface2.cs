...
namespace Idltest.Diamonds {
    ...
    public class TestInterface2Struct : TestInterface2 {
        public static readonly string RTTI_PACKAGE = "idltest.diamonds.TestInterface2";
        public static readonly string RTTI_CLASSNAME = "Struct";
        public static readonly string RTTI_FULLCLASSNAME = "idltest.diamonds.TestInterface2.Struct";
