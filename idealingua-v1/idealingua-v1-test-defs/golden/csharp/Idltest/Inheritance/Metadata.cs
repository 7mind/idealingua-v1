...
namespace Idltest.Inheritance {
    ...
    public class MetadataStruct : Metadata {
        public static readonly string RTTI_PACKAGE = "idltest.inheritance.Metadata";
        public static readonly string RTTI_CLASSNAME = "Struct";
        public static readonly string RTTI_FULLCLASSNAME = "idltest.inheritance.Metadata.Struct";
