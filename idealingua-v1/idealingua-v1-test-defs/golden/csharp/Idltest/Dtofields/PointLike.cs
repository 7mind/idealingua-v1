...
namespace Idltest.Dtofields {
    ...
    public class PointLikeStruct : Metadata, PointLike {
        public static readonly string RTTI_PACKAGE = "idltest.dtofields.PointLike";
        public static readonly string RTTI_CLASSNAME = "Struct";
        public static readonly string RTTI_FULLCLASSNAME = "idltest.dtofields.PointLike.Struct";
