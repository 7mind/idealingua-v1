        ...
        req.as[Json].flatMap { body =>
          ...
          nameOpt match {
            ...
            case Some(`toolName_testADTIdReturn`) =>
              call(req, argsJson, methodId_testADTIdReturn, wrap = true, extractCtx, mux, dsl)
            case Some(`toolName_testADTIdImportedReturn`) =>
              call(req, argsJson, methodId_testADTIdImportedReturn, wrap = true, extractCtx, mux, dsl)
