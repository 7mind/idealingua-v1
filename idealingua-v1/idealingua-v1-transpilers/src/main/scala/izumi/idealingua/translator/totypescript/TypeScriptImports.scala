...
object TypeScriptImports {
  ...
  protected def fromTypes(types: List[TypeId], fromPkg: Package, extra: List[TypeScriptImport] = List.empty, manifest: TypeScriptBuildManifest)
  ...
  protected def fromDefinition(ts: Typespace, definition: TypeDef, fromPkg: Package, extra: List[TypeScriptImport] = List.empty, manifest: TypeScriptBuildManifest)
    : List[TypeScriptImport] = {
  ...
  protected def fromService(ts: Typespace, svc: Service, fromPkg: Package, extra: List[TypeScriptImport] = List.empty, manifest: TypeScriptBuildManifest)
    : List[TypeScriptImport] = {
  ...
  protected def fromBuzzer(ts: Typespace, i: Buzzer, fromPkg: Package, extra: List[TypeScriptImport] = List.empty, manifest: TypeScriptBuildManifest)
    : List[TypeScriptImport] = {
